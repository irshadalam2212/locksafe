...
const Manager = () => {
  ...
  const showPassword = () => {
    ...
    if (ref.current.value == "Show") {
      ref.current.value = "Hide";
      passwordRef.current.type = "password";
    } else {
      ref.current.value == "Hide";
      ref.current.value = "Show";
      passwordRef.current.type = "text";
    }
  };
  ...
  const savePassword = () => {
    if (
      ...
      alert("Length should be 3 character");
    }
  };
      ...
      <div className="p-2 md:p-0 md:mycontainer min-h-[81.5vh]">
        ...
        <div className="flex flex-col p-4 gap-8 items-center">
          ...
          <button
            ...
            className="flex justify-center items-center gap-4 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit"
          >
            <lord-icon
